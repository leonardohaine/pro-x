;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      removeSelectedLabel: 'Remove selecionado',
      ...
      infoText: '{0} itens selecionados',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-primary">Filtrado</span> {0} de {1}', // when not all of the options are visible due to the filter
