...
public class CertificadoService {
    ...
    public static Certificado certificadoPfxBytes(byte[] certificadoBytes, String senha) throws CertificadoException {
        ...
        try {
        	System.out.println("Bytes Certificado digital: " + certificadoBytes);
            ...
            certificado.setEmissao(DataEmissao(certificado).toInstant().atZone(ZoneId.systemDefault()).toLocalDate());
    ...
    /**
     * Método  que retorna a Data De Emissao Do Certificado Digital
     *
     * @param certificado
     * @return
     * @throws CertificadoException
     */
    public static Date DataEmissao(Certificado certificado) throws CertificadoException {
